...
type AccountFetcher interface {
	...
	FetchAccount(ctx context.Context, accountID string) (*config.Account, error)
}
...
func (f *fetcherWithCache) FetchAccount(ctx context.Context, accountID string) (*config.Account, error) {
